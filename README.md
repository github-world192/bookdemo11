# The Star 東方之星度假飯店 — 使用說明

這是一份給**非技術背景**測試人員看的說明。內容包含：如何在本機把網站跑起來、前台與後台要從哪裡進入、以及測試用的帳號密碼。

---

## 這是什麼？

這是一個**度假飯店訂房網站**的示範版本，包含：

- **前台**：一般旅客瀏覽飯店、查空房、訂房、逛商城
- **後台**：飯店員工登入後，管理房型、訂單、會員等

網站跑在您自己的電腦上，資料存在記憶體中（關閉程式後會重置），適合課程展示與功能測試。
